...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">{{ $title }} Düzenle</h3>
    </div>
    <div class="card-body">
        @if($errors->any())
        ...
        <form action="{{ route('admin.menu.food.update', ['type' => $type, 'food' => $item->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row mb-5">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="calories" class="form-control @error('calories') is-invalid @enderror" value="{{ old('calories', $item->calories) }}" min="0" max="2000" required>
                    @error('calories')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row mb-5">
                <div class="col-12">
                    <div class="form-check form-switch form-check-custom form-check-solid">
                        <input class="form-check-input" type="checkbox" name="is_vegetarian" value="1" id="is_vegetarian" {{ old('is_vegetarian', $item->is_vegetarian) ? 'checked' : '' }}>
            ...
            <div class="row mb-5">
                <div class="col-12">
                    <div class="form-check form-switch form-check-custom form-check-solid">
                        <input class="form-check-input" type="checkbox" name="is_hot" value="1" id="is_hot" {{ old('is_hot', $item->is_hot) ? 'checked' : '' }}>
