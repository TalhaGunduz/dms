    ...
    <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
        ...
        <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
            ...
            <div class="d-flex align-items-center gap-2 gap-lg-3">
                ...
                <a href="{{ $button_link }}" class="btn btn-sm fw-bold btn-primary">{{ $model_text }} Listesine Dön</a>
                <!--end::Primary button-->
            </div>
            <!--end::Actions-->
        </div>
                ...
                <div class="card-body py-4">
                    ...
                    <form class="form" action="{{ route('admin.' . $model . '.update', ['id' => $data->id]) }}"
                        ...
                        <div class="fv-row mb-10">
                            <!--begin::Label-->
                            <label class="fs-6 fw-semibold form-label mb-2">{{ $model_text }} Adı:</label>
                            <!--end::Label-->
                        ...
                        <div class="fv-row mb-10">
                            <!--begin::Label-->
                            <label class="fs-6 fw-semibold form-label mb-2">{{ $model_text }} Gmaili:</label>
                            <!--end::Label-->
                            <input type="text" name="email" value="{{ old('email', $data->email) }}" id="email"
                                class="form-control">
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-10">
                            <!--begin::Label-->
                            <label class="fs-6 fw-semibold form-label mb-2">{{ $model_text }} Şifresi:</label>
                            <!--end::Label-->
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-warning">
                                <span class="indicator-label">{{ $model_text }} Düzenle</span>
