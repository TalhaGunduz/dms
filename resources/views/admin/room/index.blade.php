                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <i class="ki-duotone ki-settinsg fs-2">
                                <span class="path1"></span>
                                <span class="path2"></span>
                            </i> Kullanıcı Ayarlar</button>
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true">
                                <!--begin::Header-->
                                <div class="px-7 py-5">
                                    <div class="fs-5 text-dark fw-bold"> Kullanıcı Durumu</div>
                                </div>
                                <!--end::Header-->
                                <!--begin::Separator-->
                                ...
                                <div class="px-7 py-5" data-kt-user-table-filter="form">
                                    ...
                                    <!--begin::Input group-->
                                    <div class="mb-10">
                                        <label class="form-label fs-6 fw-semibold"> Durumu </label>
                                    ...
                                    <div class="d-flex justify-content-end">
                                        <button type="submit" class="btn btn-primary fw-semibold px-6" data-kt-menu-dismiss="true" data-kt-user-table-filter="filter">Kaydet</button>
                                    </div>
                                    <!--end::Actions-->
                                </div>
                                <!--end::Content-->
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#table').DataTable({
            ...
            ajax: {
                type: 'GET',
                url: "{{ route('admin.room.data') }}", // Room verilerini alacak olan url
            },
            columns: [
                {
                    data: 'id',
